...
<html  lang="it">
    ...
    <body>
        ...
        <div class="container">
          <div class="collapse navbar-collapse" id="nav-ham">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="account.html" class="nav-link bi bi-person-circle"></a></li>
      ...
      <div class="page-content">
        <div class="container">
          <h1>Contenuto sotto la navbar</h1>
          <h2>Contenuto sotto la navbar</h2>
          <h3>Contenuto sotto la navbar</h3>
          <h4>Contenuto sotto la navbar</h4>
          <p>Qui puoi aggiungere il contenuto della tua pagina.</p>
          <a class="rotate" href="#">Link e collegamenti.</a>
        </div>
      </div>
